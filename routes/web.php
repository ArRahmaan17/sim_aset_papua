...
Route::middleware(['throttle:application', 'authenticated', 'have-organisasi'])->group(function () {
    ...
    Route::name('master.')->group(function () {
        ...
        Route::get('/master/menu', [MenuController::class, 'index'])->name('menu')->middleware(['menu-permission']);
        ...
        Route::get('/master/barang', [BarangController::class, 'index'])->name('barang')->middleware(['menu-permission']);
        ...
        Route::get('/master/masamanfaat', [MasaManfaatController::class, 'index'])->name('masamanfaat')->middleware(['menu-permission']);
        ...
        Route::get('/master/organisasi', [OrganisasiController::class, 'index'])->name('organisasi')->middleware(['menu-permission']);
        ...
        Route::get('/master/warna', [WarnaController::class, 'index'])->name('warna')->middleware(['menu-permission']);
        ...
        Route::get('/master/lokasi', [LokasiController::class, 'index'])->name('lokasi')->middleware(['menu-permission']);
        ...
        Route::get('/master/ruangan', [RuanganController::class, 'index'])->name('ruangan')->middleware(['menu-permission']);
        ...
        Route::get('/master/kondisi', [KondisiController::class, 'index'])->name('kondisi')->middleware(['menu-permission']);
        ...
        Route::get('/master/klasifikasi', [KlasifikasiController::class, 'index'])->name('klasifikasi')->middleware(['menu-permission']);
        ...
        Route::get('/master/jurnal', [JurnalController::class, 'index'])->name('jurnal')->middleware(['menu-permission']);
        ...
        Route::get('/master/jenis-transaksi', [JenisTransaksiController::class, 'index'])->name('jenis-transaksi')->middleware(['menu-permission']);
        ...
        Route::get('/master/kapitalisasi', [KapitalisasiController::class, 'index'])->name('kapitalisasi')->middleware(['menu-permission']);
        ...
        Route::get('/master/asal-usul', [AsalUsulController::class, 'index'])->name('asal-usul')->middleware(['menu-permission']);
        ...
        Route::get('/master/satuan', [SatuanController::class, 'index'])->name('satuan')->middleware(['menu-permission']);
        ...
        Route::get('/master/statustanah', [StatusTanahController::class, 'index'])->name('statustanah')->middleware(['menu-permission']);
        ...
        Route::get('/master/golonganbarang', [GolonganBarangController::class, 'index'])->name('golonganbarang')->middleware(['menu-permission']);
        ...
        Route::get('/master/rehab', [RehabController::class, 'index'])->name('rehab')->middleware(['menu-permission']);
